...
class MainWindow(QtWidgets.QWidget):
    ...
    def setup_ui(self):
        ...
        self.rb_timer_2 = QtWidgets.QRadioButton("2 ms")
        self.rb_timer_default = QtWidgets.QRadioButton("Default")
        self.rb_timer_1.setChecked(True)
        tg_layout.addWidget(self.rb_timer_1)
        tg_layout.addWidget(self.rb_timer_2)
        tg_layout.addWidget(self.rb_timer_default)
        timer_group.setLayout(tg_layout)
        layout.addWidget(timer_group)

        # Connect signals to enable/disable frequency group
        self.rb_timer_default.toggled.connect(self.update_frequency_state) 
        self.rb_timer_1.toggled.connect(self.update_frequency_state) 
        self.rb_timer_2.toggled.connect(self.update_frequency_state)
